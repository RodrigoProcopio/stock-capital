...
(() => {
  ...
  // CSS só do preview (mantém parecido com o card do site)
  const previewCss = `
  ...
  // Registre para sua(s) coleção(ões). Ex.: "cartas"
  CMS.registerPreviewTemplate('cartas', CardPreview);
  // Se tiver outras coleções com o mesmo card, descomente:
  // ['relatorios','insights','compliance'].forEach(c => CMS.registerPreviewTemplate(c, CardPreview));
})();
